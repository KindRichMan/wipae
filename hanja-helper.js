...
const DATA={
 ...
 title:[['후인','後人'],['유인','孺人'],['학생','學生'],['처사','處士'],['공','公'],['대부인','大夫人']],
 surname:[
  ['김','金'],['이','李'],['박','朴'],['최','崔'],['정','鄭'],['정','丁'],['정','程'],
  ['강','姜'],['강','康'],['강','強'],['조','趙'],['조','曺'],['윤','尹'],['장','張'],['장','蔣'],['임','林'],['임','任'],['한','韓'],
  ['오','吳'],['서','徐'],['신','申'],['신','辛'],['신','愼'],['권','權'],['황','黃'],['안','安'],['송','宋'],['전','全'],['전','田'],['홍','洪'],
  ['유','柳'],['유','劉'],['유','兪'],['고','高'],['문','文'],['양','梁'],['양','楊'],['손','孫'],['배','裵'],['백','白'],['허','許'],
  ['남','南'],['심','沈'],['노','盧'],['노','魯'],['하','河'],['곽','郭'],['성','成'],['차','車'],['주','朱'],['주','周'],['우','禹'],
  ['구','具'],['구','丘'],['민','閔'],['진','陳'],['지','池'],['엄','嚴'],['채','蔡'],['원','元'],['천','千'],['방','方'],['공','孔'],
  ['현','玄'],['함','咸'],['변','卞'],['염','廉'],['여','呂'],['추','秋'],['도','都'],['석','石']
 ]
};
...
function ensurePopup(){if(document.getElementById('hanjaPopup'))return;const p=document.createElement('div');p.id='hanjaPopup';p.className='hanja-popup';p.innerHTML='<div class="hanja-card"><div class="hanja-card-head"><b id="hanjaPopTitle">한자 쉽게 입력</b><span></span><button type="button" class="hanja-close">✕ 닫기</button></div><input id="hanjaSearch" class="hanja-search" placeholder="한글로 검색하세요. 예: 아버지, 김, 유인"><div id="hanjaResults" class="hanja-results"></div><div class="hanja-help-note">원하는 항목을 누르면 입력칸에 한자가 자동으로 들어갑니다. 같은 성의 한자가 여러 개면 본인 성씨에 맞는 글자를 선택하세요. 찾는 글자가 없으면 닫고 직접 입력할 수도 있습니다.</div></div>';document.body.appendChild(p);p.querySelector('.hanja-close').onclick=hide;p.onclick=e=>{if(e.target===p)hide();};document.getElementById('hanjaSearch').oninput=renderPopup;}
